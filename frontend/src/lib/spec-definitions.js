export const COMPONENT_SPECS = {
    'Processeurs': [
        ...
        { key: 'tdp', label: 'TDP', type: 'number', placeholder: 'e.g., 125' },
    ...
    'Cartes Graphiques': [
        ...
        { key: 'length', label: 'Length', type: 'number', placeholder: 'e.g., 310' },
        { key: 'tdp', label: 'TDP', type: 'number', placeholder: 'e.g., 320' },
    ...
    'Alimentation': [
        { key: 'wattage', label: 'Wattage', type: 'number', placeholder: 'e.g., 850' },
    ...
    'Boîtiers': [
        ...
        { key: 'maxGPULength', label: 'Max GPU Length', type: 'number', placeholder: 'e.g., 400' },
